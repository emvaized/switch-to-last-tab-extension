...
- Shows a small badge when switched to previous tab
- Provides a keyboard hotkey (default: <kbd>Alt</kbd>+<kbd>Q</kbd>, can be changed)
- Focuses last active tab on tab close
...
This extension is based on [Last Tab Button](https://github.com/pruna00/lasttabbtn), which I adapted for Chrome, updated icon, optimized code and added few features.
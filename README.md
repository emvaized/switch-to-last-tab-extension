...
- Provides a keyboard hotkey (default: Alt+Q, change on `chrome://extensions/shortcuts` page)
- Slightly changes icon on each click to easier distinguish between tabs
- Option to show a small badge when switched to previous tab, which will be removed once you switch to another tab
- Option to focus last active tab when current tab closed 
